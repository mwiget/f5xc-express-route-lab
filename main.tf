module "spoke_vnet_a" {
  ...
  vnet_cidr_block         = "10.101.16.0/22"
  vnet_subnet_cidr_block  = "10.101.16.0/24"
...
module "spoke_vnet_b" {
  ...
  vnet_cidr_block         = "10.101.20.0/22"
  vnet_subnet_cidr_block  = "10.101.20.0/24"
  instance_template_data  = {
    tailscale_key   = var.tailscale_key,
...
module "azure-site-2" {
  ...
  f5xc_azure_site_name                = format("%s-azure-site-2", var.project_prefix)
  f5xc_azure_vnet_site_resource_group = format("%s-azure-site-2-rg", var.project_prefix)
  f5xc_azure_vnet_primary_ipv4        = "10.101.8.0/22"
  f5xc_azure_ce_gw_type               = "multi_nic"
  f5xc_azure_az_nodes                 = {
    node0 : {
      f5xc_azure_az                  = "1", f5xc_azure_vnet_inside_subnet = "10.101.8.0/24",
      f5xc_azure_vnet_outside_subnet = "10.101.9.0/24"
    }
    node1 : {
      f5xc_azure_az                  = "2", f5xc_azure_vnet_inside_subnet = "10.101.8.0/24",
      f5xc_azure_vnet_outside_subnet = "10.101.9.0/24"
    }
    node2 : {
      f5xc_azure_az                  = "3", f5xc_azure_vnet_inside_subnet = "10.101.8.0/24",
      f5xc_azure_vnet_outside_subnet = "10.101.9.0/24"
    }
  }
